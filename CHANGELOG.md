...
_The anti-blur / adaptive-perf / A/B-pack-tooling release-candidate stream,
merged with the 0.23.1 plugin-hooks work.  The full 0.24.0 entry (blur/perf
prop regroup, seam-finder + threading default flips) is authored at release
time; the drafted rc-stream content that was briefly (and mistakenly) published
as a withdrawn 0.23.0 follows._

## [0.23.0] — 2026-08-03 (withdrawn — folded into 0.24.0)
